...
function system_controll($text)
{
  ...
  // print_r($matches);
   //ปั๊ม 1 เปิด
   if($pump1_1[0][0]=="เปิดปั๊ม1"){ $text_reply = "เปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_on; }
   elseif($pump1_2[0][0]=="เปิดปั๊ม 1"){ $text_reply = "เปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_on; }
   elseif($pump1_3[0][0]=="pump 1 on"){ $text_reply = "เปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_on; }
   //ปั๊ม 1 ปิด
   elseif($pump1_4[0][0]=="pump 1 off"){ $text_reply = "ปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_off; }
   elseif($pump1_5[0][0]=="ปิดปั๊ม1"){ $text_reply = "ปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_off; }
   elseif($pump1_6[0][0]=="ปิดปั๊ม 1"){ $text_reply = "ปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_off; }
   //ปั๊ม 2 เปิด
   elseif($pump2_1[0][0]=="เปิดปั๊ม2"){ $text_reply = "เปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_on; }
   elseif($pump2_2[0][0]=="เปิดปั๊ม 2"){ $text_reply = "เปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_on; }
   elseif($pump2_3[0][0]=="pump 2 on"){ $text_reply = "เปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_on; }
   //ปั๊ม 2 ปิด
   elseif($pump2_4[0][0]=="pump 2 off"){ $text_reply = "ปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_off; }
   elseif($pump2_5[0][0]=="ปิดปั๊ม2"){ $text_reply = "ปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_off; }
   elseif($pump2_6[0][0]=="ปิดปั๊ม 2"){ $text_reply = "ปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_off; }
   //เปิดปั๊มทุกตัว
   elseif($pump12_1[0][0]=="pump all on"){ $text_reply = "เปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_on."\n"."เปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_on; }
   elseif($pump12_2[0][0]=="เปิดปั๊มทั้งหมด"){ $text_reply = "เปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_on."\n"."เปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_on; }
   //ปิดปั๊มทุกตัว
   elseif($pump12_3[0][0]=="ปิดปั๊มทั้งหมด"){ $text_reply = "ปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_off."\n"."ปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_off; }
   elseif($pump12_4[0][0]=="pump all off"){ $text_reply = "ปิดปั๊ม 1 แล้ว สถานะ : ".$bin1_off."\n"."ปิดปั๊ม 2 แล้ว สถานะ : ".$bin2_off; }
