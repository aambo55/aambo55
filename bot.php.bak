...
{
     //ประกาศ Array คำคอบ
        $answer_yes =array("ใช่ครับ","ใช่ๆเห็นมากับตาเลย","ไม่แน่ใจอะ","ไม่รู้ซิ","พอดีไม่ชอบเผือกครับ","ว่างมากเหรอ","ใช่แล้ว","ใช่เลย","มั่วแระ","แม่นแล้ว","หมันเลย","ใช่แล้วไงอะ","จะใช่หรือไม่ใช่ก็อยู่เฉยๆไว้ดีกว่า");
		$answer_true =array("จริงครับ","จริง เคยเห็น","ไม่แน่ใจอะ","ไม่รู้ซิ","พอดีไม่ชอบเผือกครับ","ว่างมากเหรอ","จริงแท้แน่นอน","เป็นเรื่องจริง","มั่วแระ","แม่นแล้ว","จริงแล้วไงอะ","ขอถามเพื่อนดูก่อน","จริงซิจ๊ะ","ไม่จริงอะ");
     // สุ่มคำตอบ
